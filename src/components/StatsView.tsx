...
interface StatsViewProps {
  ...
  /** Racha actual; si se omite (vista admin) no se muestra la recomendación de racha. */
  streak?: number;
}
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          ...
          <p className="text-2xl font-bold text-green-600">
            {getAccuracyPercentage(correctExercises, totalExercises)}%
          </p>
        </div>
      ...
      <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
        ...
        <ul className="text-sm text-yellow-700 space-y-1">
          ...
          {getAccuracyPercentage(correctExercises, totalExercises) < 70 && (
            <li>• Revisa las explicaciones cuando falles</li>
          )}
          {streak !== undefined && streak < 5 && (
